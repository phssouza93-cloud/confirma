...
import { cadastroAction } from "../login/actions";
        ...
        <div className="bg-white border border-[#E6F9FC] rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            <p className="text-xs text-[#706F6F] mb-5">
              Primeira conta cadastrada vira admin.
            </p>
            ...
            <form action={cadastroAction} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm focus:border-[#326A84] focus:ring-2 focus:ring-[#64C3D1]/30 outline-none"
                />
                <p className="text-xs text-[#706F6F] mt-1.5 leading-relaxed">
            ...
            <div className="mt-6 pt-6 border-t border-slate-100 text-center">
              <p className="text-xs text-[#706F6F]">
                Já tem conta?{" "}
                <Link href="/login" className="text-[#326A84] font-semibold hover:underline">
                  Entrar
                </Link>
              </p>
            </div>
